...
export const mockIncidentInProgress: IIncident = {
  ...
  relatedRecords: null,
  attachments: null,
  followers: JSON.stringify(['admin@picks.com']),
  internalFollowers: null,
  draftExpiresAt: null,
  clientPrimaryContact: null,
  billingCode: null,
...
export const mockIncidentResolved: IIncident = {
  ...
  followers: JSON.stringify(['user@picks.com']),
  internalFollowers: null,
  draftExpiresAt: null,
  clientPrimaryContact: null,
  billingCode: null,
...
export const mockIncidentClosed: IIncident = {
  ...
  resolvedBy: 'admin@picks.com',
  closedAt: new Date('2026-01-31T18:00:00Z'),
  closedBy: 'admin@picks.com',
  reopenedAt: null,
  reopenedBy: null,
  approvedAt: null,
  approvedBy: null,
...
export const mockIncidentDraft: IIncident = {
  ...
  primaryResource: 'admin@picks.com',
  secondaryResources: null,
...
export const mockIncidentMajor: IIncident = {
  ...
  followers: JSON.stringify(['admin@picks.com', 'cto@company.com']),
  internalFollowers: JSON.stringify(['admin@picks.com']),
  draftExpiresAt: null,
  clientPrimaryContact: null,
  billingCode: null,
  approvedEstimatesHours: null,
