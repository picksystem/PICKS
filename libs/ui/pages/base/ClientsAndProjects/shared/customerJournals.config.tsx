...
import type { IConfigCustomerJournal } from '@serviceops/interfaces';

export const ACCENT = '#0369a1';

export const CUSTOMER_JOURNALS_ICON = <ReceiptLongIcon sx={{ fontSize: '1.1rem' }} />;

// ── Column Definitions ─────────────────────────────────────────────────────────

export const customerJournalColumns: Column<IConfigCustomerJournal>[] = [
