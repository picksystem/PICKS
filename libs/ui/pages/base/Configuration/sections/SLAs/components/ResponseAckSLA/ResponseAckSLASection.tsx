...
import ResponseAckSLAFormDialog from '@serviceops/pages/base/Configuration/dialogs/ResponseAckSLAFormDialog/ResponseAckSLAFormDialog';
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box>
            <Typography className={classes.sectionTitle}>
              Response / Acknowledgement SLA (in minutes)
            </Typography>
            <Typography className={classes.sectionSubtitle}>
              Configure response time targets and breach alerting for initial acknowledgement
            </Typography>
          </Box>
        </Box>
      </AccordionSummary>
