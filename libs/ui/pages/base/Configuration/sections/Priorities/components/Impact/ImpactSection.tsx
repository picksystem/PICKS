...
const IMPACT_CONFIG = {
  title: 'Impact',
  subtitle:
    'Define impact levels — how broadly a ticket affects the business, and control which ticket types each impact applies to',
  accent: '#0369a1',
...
const ImpactSection = ({
  ...
  /**
   * Required-field validation per the spec for the Impact section:
   *   Impact (displayName)  — Yes
  ...
  const handleSubmit = useCallback(async () => {
    ...
    // border / helper text on Impact, Short Description, and Description
