...
export const WORKING_DAY_TEMPLATE_CONFIG: TableConfig = {
  ...
  fields: [
    ...
    { name: 'mondayHours', label: 'Monday', type: 'number', defaultValue: 8 },
    { name: 'tuesdayHours', label: 'Tuesday', type: 'number', defaultValue: 8 },
    { name: 'wednesdayHours', label: 'Wednesday', type: 'number', defaultValue: 8 },
    { name: 'thursdayHours', label: 'Thursday', type: 'number', defaultValue: 8 },
    { name: 'fridayHours', label: 'Friday', type: 'number', defaultValue: 8 },
    { name: 'saturdayHours', label: 'Saturday', type: 'number', defaultValue: 0 },
    { name: 'sundayHours', label: 'Sunday', type: 'number', defaultValue: 0 },
  ],
};
