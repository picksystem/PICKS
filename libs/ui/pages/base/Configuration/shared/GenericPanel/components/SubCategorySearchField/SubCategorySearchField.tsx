...
export interface SubCategorySearchFieldProps {
  label: string;
  value: string;
...
export const SubCategorySearchField = ({
  ...
  const { categorization, isLoading: configLoading } = useConfiguration();

  const allOptions = useMemo(() => {
    if (!categorization?.applicationSubCategories) return [];
  ...
  return (
    <Box sx={{ position: 'relative' }}>
      <TextField
        label={label}
        placeholder='Search application sub-categories...'
        value={inputValue}
        onChange={(e) => {
