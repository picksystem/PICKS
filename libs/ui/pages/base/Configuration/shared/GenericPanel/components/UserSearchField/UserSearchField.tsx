...
/**
 * Search field for fields like "Lead Consultant" / "Manager" on the Add
 * Consultant Profile dialog — options are every user in the system (User
 * Management > All Users), unlike ConsultantSearchField which scopes to
 * role === 'consultant'.
 */
export const UserSearchField = ({
  ...
  const allOptions = useMemo(
    () => allUserOptions.map((u) => ({ id: String(u.id), name: u.name })),
    [allUserOptions],
  );
