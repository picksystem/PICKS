...
export interface ApplicationSearchFieldProps {
  label: string;
  value: string;
...
export const ApplicationSearchField = ({
  label,
  value,
  onChange,
  required,
  ...
  const { options: allOptions, isLoading } = useSharedApplications();
...
export default ApplicationSearchField;
