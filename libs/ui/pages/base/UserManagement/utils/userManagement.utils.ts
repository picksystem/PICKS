...
export const AdminCreateUserSchema = yup.object({
  ...
  accessFromDate: yup.string().optional().nullable(),
  accessToDate: yup.string().optional().nullable(),
  ...
  application: yup.string().optional().nullable(),
  applicationLead: yup.string().optional().nullable(),
