        ...
        >
          ...
          {[
            ...
            },
            {
              ...
              value: 'callerReportingManager' in incident ? incident.callerReportingManager : null,
            },
    ...
    clientContacts: (
      <Box key='clientContacts' className={classes.infoItem}>
        ...
        <Typography className={classes.infoValue}>
          {/* Incident-only field — not present on Service/Advisory Requests */}
          {('additionalContacts' in incident && incident.additionalContacts) || '-'}
        </Typography>
      </Box>
    ),
