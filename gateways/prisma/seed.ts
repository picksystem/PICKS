...
async function clearAndSeed() {
  ...
  await pool.query(`
    ...
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('incident', 'Incident', 'Incident', 'Unplanned interruption or quality reduction', 'Unplanned interruption or quality reduction in a service', 'INC', true, 7, 1, 'AdminIncident');
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('service_request', 'Service Request', 'Service Request', 'Formal request for access or provisioning', 'Formal request for access, installation, or provisioning of a service', 'SR', true, 7, 2, 'AdminServiceRequest');
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('advisory_request', 'Advisory Request', 'Advisory Request', 'Advisory and consultation request', 'Advisory and consultation request for guidance and recommendations', 'AR', true, 7, 3, 'AdminAdvisoryRequest');
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('task', 'Task', 'Task', 'Task and work item tracking', 'Task and work item tracking', 'T', true, 6, 4, 'AdminServiceRequest');
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('change_request', 'Change Request', 'Change Request', 'Formal proposal to modify existing system', 'Formal proposal to modify an existing system requiring review and approval', 'CR', true, 7, 5, 'AdminServiceRequest');
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('problem_request', 'Problem Request', 'Problem Request', 'Identify and eliminate root cause', 'Identify and eliminate the root cause of recurring incidents', 'PR', true, 7, 6, 'AdminServiceRequest');
    INSERT INTO "AdminTicketType" ("type", "name", "displayName", "shortDescription", "description", "prefix", "isActive", "numberLength", "displayOrder", "model") VALUES ('ticket_template', 'Ticket Template', 'Ticket Template', 'Template definitions for ticket creation', 'Template definitions for ticket creation', 'TB', true, 5, 7, 'AdminServiceRequest');
