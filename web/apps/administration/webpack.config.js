...
// Get partner from environment variable or use base app name
// Usage: PARTNER=generale-partner npm run serve:administration
const PARTNER = process.env.PARTNER || 'administration';
const APP_NAME = 'administration'; // Base app name

console.log('🔵 Building Administration App');
